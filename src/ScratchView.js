...
import { StyleSheet, Animated, requireNativeComponent, ImageBackground } from 'react-native';
import imageSample from  'resource/image/LuckyCoiPagcorF.jpg';


const RNTScratchView = requireNativeComponent('RNTScratchView', ScratchView);

let AnimatedScratchView = RNTScratchView && Animated.createAnimatedComponent(RNTScratchView);
